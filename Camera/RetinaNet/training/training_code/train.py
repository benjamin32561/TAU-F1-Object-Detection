...
def main(args=None):
    ...
    parser.add_argument('--test_batch_size', help='Training batch size',type=int, default=4)
    ...
    if dataset_val is not None:
        sampler_val = AspectRatioBasedSampler(dataset_val, batch_size=parser.test_batch_size, drop_last=False)
